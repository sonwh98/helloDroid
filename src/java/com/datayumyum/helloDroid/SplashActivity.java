package com.datayumyum.helloDroid;
...
import com.datayumyum.helloDroid.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.datayumyum.helloDroid.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.datayumyum.helloDroid.MyActivity");
